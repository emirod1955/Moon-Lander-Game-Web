                ...
                <Fade><div className="MacOSBox">
                    <div className="DivsDownload"> 
                        ...
                        <div className="MacOSText">
                            ...
                            <a href="https://drive.google.com/file/d/1FOFxHdBVBZ6d_BeXz9hDCLAu1abCDGh_/view?usp=sharing" download><input id="MacOSButton" type="button" value="Download now"></input></a>
